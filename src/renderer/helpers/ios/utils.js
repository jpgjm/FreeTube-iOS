// -----------------------------------------------------------------------------
// iOS 版 ユーティリティ関数群。
// Android 版と同一実装 (プラットフォーム差の無い純ロジック)。
// 互換性のため export シグネチャも同じに保つ。
// -----------------------------------------------------------------------------
...
/**
 * detects the real file type of an `octet-stream` mime-typed file
 * (iOS のドキュメントピッカー経由でも同様に MIME があいまいになる場合がある)
